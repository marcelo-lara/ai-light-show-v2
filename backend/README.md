...
- `fade_out` is the dedicated fade-to-zero effect. Par cans ramp their current RGB values down to `0`, and moving heads ramp their dimmer down to `0` over the cue duration.
