...
2. Write or revise the GPT magic show plan inside `lighting_score.md` so the creative direction, fixture roles, and section plan stay explicit and current with the available artifacts.
