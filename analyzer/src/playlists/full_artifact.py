...
FULL_ARTIFACT_PLAYLIST_METADATA = {
    ...
    "produces": ["info.json", "reference/beats.json or inferred/beats.<model>.json", "chord_patterns.json", "stem_patterns.json", "sections.json", "hints.json", "features.json", "essentia artifacts", "stems", "song markdown summary"],
}
