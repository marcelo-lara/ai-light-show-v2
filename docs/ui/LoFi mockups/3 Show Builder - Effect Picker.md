# Show Builder - Effect Picker

## Considerations
- The 'time' input is read-only based on the current song position. The user moves the current position with the song player.
- The Fixture dropdown has all the fixtures available.
